...
const SELECT_KB_INSTRUCTION = '<h2>Choose the keyboard that most closely resembles yours</h2>'; 
const SELECT_KB_PROMPT = "Look at the first 6 <strong>letters</strong> of your keyboard.";
...
let test_keyboard_key_left = {
    ...
    post_trial_gap: 1000,
    prompt: "Respon within 10 seconds.",
...
let test_keyboard_key_right = {
    ...
    trial_duration: 10000,
    post_trial_gap: 1000,
    prompt: "Respond within 10 seconds.",
    confirmed: false, // whether or not the particpant pressed the expected button
